function InfoClientes() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-300 to-red-600 p-6">
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="col-span-3 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-red-900 rounded-full flex items-center justify-center h-56 text-white">
              Cashback / Prêmio
            </div>
          </div>
