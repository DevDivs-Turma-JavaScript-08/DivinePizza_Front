      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="col-span-1 bg-red-900 text-white rounded-2xl p-4 shadow-md">
          ...
          <div className="mt-4">
            ...
            <button className="bmt-6 bg-red-700 hover:bg-green-600 px-4 py-2 rounded-lg w-full">
              Sem pedido no momento
            </button>
          </div>

        <button className="mt-6 bg-red-700 hover:bg-green-600 px-4 py-2 rounded-lg w-full">
            Editar Informações
          </button>
        ...
        <div className="col-span-3 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-2 bg-red-900 rounded-xl h-56 p-4 text-white">
              Quantidade de pedidos (gráfico aqui)
            </div>
            <div className=" flex flex-col bg-red-900 rounded-xl h-56 flex items-center justify-center h-56 text-white gap-2">
          ...
          <div className="bg-red-900 rounded-xl p-4 text-white">
            ...
            <div className="flex justify-between border-b border-red-700 py-2">
              <p className="flex items-center gap-3"> <div className="bg-white rounded-full w-10 h-10 "></div> Sabor da Pizza</p>
