			...
			<div className="flex flex-col rounded-2xl bg-[#E77F7350] m-10">
				<div className=" flex justify-center gap-8 p-4  ">
					<div className="bg-(--secondary) rounded-2xl text-center py-3.5 px-8 text-white">
						...
						<p className="text-sm">
							Quantidade de pedidos <br /> por mês
						</p>
					</div>
					<div className="bg-(--secondary) rounded-2xl text-center py-3.5 px-8 text-white ">
					...
					<div className="bg-(--secondary) rounded-2xl text-center py-3.5 px-9 text-white">
						<p> % </p>
						<p>
							Índice de Fidelidade <br /> do Cliente
						</p>
					</div>
				...
				<div className=" flex justify-center gap-8 p-4">
					<div className="bg-(--secondary) rounded-2xl text-center py-25.5 px-56 text-white">Ultimos pedidos</div>

					<div className="bg-(--secondary) rounded-2xl text-center py-25.5 px-60 text-white">Outros itens</div>
				</div>
			</div>
		</div>
	);
